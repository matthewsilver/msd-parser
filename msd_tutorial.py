...
msd_subset_path='/Users/matthewsilver/Documents/MATLAB/MillionSongSubset'
msd_subset_data_path=os.path.join(msd_subset_path,'data')
msd_subset_addf_path=os.path.join(msd_subset_path,'AdditionalFiles')
assert os.path.isdir(msd_subset_path),'wrong path' # sanity check
# path to the Million Song Dataset code
# CHANGE IT TO YOUR LOCAL CONFIGURATION
msd_code_path='/Users/matthewsilver/Documents/MATLAB/MSongsDB'
...
msd_subset_terms_path = '/Users/matthewsilver/Documents/MATLAB/MillionSongSubset/AdditionalFiles/subset_artist_term.db'

conn = sqlite3.connect(msd_subset_terms_path)
q = "SELECT * FROM terms"
res = conn.execute(q)
tags = res.fetchall()
print tags
